...
def emotion_detector(text_to_analyze):
    # Watson NLP Emotion Detection URL
    ...
    # Task 7 Error Handling (Status Code 400 check)
    ...
    # Task 3: Parsing and formatting the successful JSON response
    ...
    # Final formatted dictionary output
    return {
        'anger': anger_score,
